            ...
            <div className=" container">
                ...
                <div className=" mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                    {faqs.map((faq, faqsIndex) => (
                        <div
                            key={faq.question}
                            className=" border bg-neutral-900 border-white/10 p-6 rounded-2xl"
                        >
                            <div className=" flex justify-between items-center">
                                ...
                                <svg
                                    ...
                                    className={twMerge(
                                        "feather feather-plus flex-shrink-0 font-medium text-lime-400",
                            ...
                            <div
                                className={twMerge(
                                    " mt-6",
                                    selectedIndex !== faqsIndex && "hidden"
                                )}
                            >
