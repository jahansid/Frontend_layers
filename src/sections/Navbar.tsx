            ...
            <section className=" py-4 lg:py-8 fixed w-full top-0 z-50">
                <div className=" container max-w-5xl ">
                    <div className=" border border-white/15 rounded-[27px]  md:rounded-full  bg-neutral-950/70 backdrop-blur">
                        <div className=" grid grid-cols-2 lg:grid-cols-3  items-center p-2 md:pr-2 px-4">
                            <div>
                                <svg
                                    width="146"
                                    height="48"
                                ...
                                >
                                    <path
                                        d="M13.2778 22.3182C14.1 19.2499 17.2539 16.096 20.3222 15.2737L39.4512 10.1474C42.5194 9.3251 44.3402 11.1459 43.5179 14.2141L38.3916 33.3431C37.5693 36.4114 34.4154 39.5653 31.3471 40.3875L12.2181 45.5139C9.14988 46.3362 7.32913 44.5154 8.15139 41.4471L13.2778 22.3182Z"
                                        fill="#A3E635"
                                        fill-opacity="0.5"
                                    />
                                    <path
